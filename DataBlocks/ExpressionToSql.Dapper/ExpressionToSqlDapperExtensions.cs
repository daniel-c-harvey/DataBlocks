...
namespace ExpressionToSql.Dapper
{
    ...
    public static class ExpressionToSqlDapperExtensions
    {
        ...
        public static Task<IEnumerable<R>> QueryAsync<T, R>(this IDbConnection cnn, Offset<T, R> sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            return QueryAsync<R>(cnn, sql, param, transaction, commandTimeout, commandType);
        }

        public static Task<IEnumerable<R>> QueryAsync<T, R>(this IDbConnection cnn, Page<T, R> sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            return QueryAsync<R>(cnn, sql, param, transaction, commandTimeout, commandType);
        }
        ...
        private static Task<IEnumerable<R>> QueryAsync<R>(IDbConnection cnn, Query sql, object param, IDbTransaction transaction, int? commandTimeout, CommandType? commandType)
        {
            ...
            return cnn.QueryAsync<R>(query, param: parameters, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        public static IEnumerable<R> Query<T, R>(this IDbConnection cnn, Limit<T, R> sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null)
        {
            return Query<R>(cnn, sql, param, transaction, buffered, commandTimeout, commandType);
        }

        public static IEnumerable<R> Query<T, R>(this IDbConnection cnn, Offset<T, R> sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null)
        {
            return Query<R>(cnn, sql, param, transaction, buffered, commandTimeout, commandType);
        }
        
        public static IEnumerable<R> Query<T, R>(this IDbConnection cnn, Page<T, R> sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null)
        {
            return Query<R>(cnn, sql, param, transaction, buffered, commandTimeout, commandType);
        }
        ...
        private static IEnumerable<R> Query<R>(IDbConnection cnn, Query sql, object param, IDbTransaction transaction, bool buffered, int? commandTimeout, CommandType? commandType)
        {
            var query = sql.ToString();
            var parameters = param ?? sql.Parameters;
            return cnn.Query<R>(query, param: parameters, transaction: transaction, buffered: buffered, commandTimeout: commandTimeout, commandType: commandType);
        }
    }
}
